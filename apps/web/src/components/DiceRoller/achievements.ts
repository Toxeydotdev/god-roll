...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: "deuce_duo",
    name: "Deuce Duo",
    description: "Roll two 2s with exactly 2 dice",
    category: "roll",
    icon: "✌️",
    reward: {
      type: "bonus_points",
    ...
    requirement: { type: "roll_exact", values: [2, 2] },
  },
  {
    id: "triple_threes",
    name: "Triple Threes",
    description: "Roll three 3s with exactly 3 dice",
    category: "roll",
    icon: "3️⃣",
    reward: {
      type: "badge",
      value: "triple_threes",
      displayName: "Triple Threes Badge",
    },
    requirement: { type: "roll_exact", values: [3, 3, 3] },
  },
  {
    id: "four_fours",
    name: "Four Fours",
    description: "Roll four 4s with exactly 4 dice",
    category: "roll",
    icon: "4️⃣",
    reward: {
      type: "dice_skin",
      value: "obsidian",
      displayName: "Obsidian Dice Skin",
    },
    requirement: { type: "roll_exact", values: [4, 4, 4, 4] },
  },
  {
    id: "five_fives",
    name: "High Five",
    description: "Roll five 5s with exactly 5 dice",
    category: "roll",
    icon: "🖐️",
    reward: {
      type: "theme",
      value: "cyan",
      displayName: "Electric Cyan Theme",
    },
    requirement: { type: "roll_exact", values: [5, 5, 5, 5, 5] },
  },
  {
    id: "six_sixes",
    name: "Devil's Dice",
    description: "Roll six 6s with exactly 6 dice",
    category: "roll",
    icon: "😈",
    reward: {
      type: "dice_skin",
      value: "devil",
      displayName: "Devil Dice Skin",
    },
    hidden: true,
    requirement: { type: "roll_exact", values: [6, 6, 6, 6, 6, 6] },
  },
  {
    id: "full_sequence",
    name: "Perfect Sequence",
    description: "Roll 1-2-3-4-5-6 with exactly 6 dice",
    category: "roll",
    icon: "🔢",
    reward: {
      type: "dice_skin",
    ...
    requirement: { type: "roll_exact", values: [1, 2, 3, 4, 5, 6] },
  },
  {
    id: "lucky_sevens",
    name: "Lucky Sevens",

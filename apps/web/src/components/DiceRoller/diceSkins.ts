...
export const DICE_SKINS: Record<string, DiceSkin> = {
  ...
  obsidian: {
    id: "obsidian",
    name: "Obsidian",
    description: "Dark volcanic glass with purple lightning",
    diceColor: "#0d0d0d",
    dotColor: "#9b59b6",
    dotOneColor: "#e74c3c",
    emissive: "#4a0080",
  ...
  devil: {
    id: "devil",
    name: "Devil's Dice",
    description: "Sinister black dice with burning red marks",
    diceColor: "#1a0000",
    dotColor: "#ff0000",
    dotOneColor: "#ffff00",
    dotStyle: "fireball",
    shapeAccentColor: "#ff3300",
    shapeCenterColor: "#ffff00",
    emissive: "#ff0000",
  ...
  rainbow: {
    id: "rainbow",
    name: "Rainbow",
    description: "Prismatic dice that shimmer with all colors",
    diceColor: "#ffffff",
    dotColor: "#ff00ff",
    dotOneColor: "#ff0000",
    emissive: "#8800ff",
